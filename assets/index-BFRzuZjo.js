 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var $u=Symbol.for("react.element"),Fu=Symbol.for("react.portal"),yo=Symbol.for("react.fragment"),wo=Symbol.for("react.strict_mode"),xo=Symbol.for("react.profiler"),ko=Symbol.for("react.provider"),So=Symbol.for("react.context"),Ny=Symbol.for("react.server_context"),Eo=Symbol.for("react.forward_ref"),Co=Symbol.for("react.suspense"),bo=Symbol.for("react.suspense_list"),_o=Symbol.for("react.memo"),Po=Symbol.for("react.lazy"),Oy=Symbol.for("react.offscreen"),Xp;Xp=Symbol.for("react.module.reference");function Xe(e){if(typeof e=="object"&&e!==null){var t=e.$$typeof;switch(t){case $u:switch(e=e.type,e){case yo:case xo:case wo:case Co:case bo:return e;default:switch(e=e&&e.$$typeof,e){case Ny:case So:case Eo:case Po:case _o:case ko:return e;default:return t}}case Fu:return t}}}H.ContextConsumer=So;H.ContextProvider=ko;H.Element=$u;H.ForwardRef=Eo;H.Fragment=yo;H.Lazy=Po;H.Memo=_o;H.Portal=Fu;H.Profiler=xo;H.StrictMode=wo;H.Suspense=Co;H.SuspenseList=bo;H.isAsyncMode=function(){return!1};H.isConcurrentMode=function(){return!1};H.isContextConsumer=function(e){return Xe(e)===So};H.isContextProvider=function(e){return Xe(e)===ko};H.isElement=function(e){return typeof e=="object"&&e!==null&&e.$$typeof===$u};H.isForwardRef=function(e){return Xe(e)===Eo};H.isFragment=function(e){return Xe(e)===yo};H.isLazy=function(e){return Xe(e)===Po};H.isMemo=function(e){return Xe(e)===_o};H.isPortal=function(e){return Xe(e)===Fu};H.isProfiler=function(e){return Xe(e)===xo};H.isStrictMode=function(e){return Xe(e)===wo};H.isSuspense=function(e){return Xe(e)===Co};H.isSuspenseList=function(e){return Xe(e)===bo};H.isValidElementType=function(e){return typeof e=="string"||typeof e=="function"||e===yo||e===xo||e===wo||e===Co||e===bo||e===Oy||typeof e=="object"&&e!==null&&(e.$$typeof===Po||e.$$typeof===_o||e.$$typeof===ko||e.$$typeof===So||e.$$typeof===Eo||e.$$typeof===Xp||e.getModuleId!==void 0)};H.typeOf=Xe;Qp.exports=H;var Ty=Qp.exports,zy=x.Fragment;function ce(e,t,n){return ju.call(t,"css")?x.jsx(yy,hy(e,t),n):x.jsx(e,t,n)}C`
  from,
  20%,
  53%,
  to {
...
`;function Hy({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=Du,iterationCount:a=1}){return ar`
  ...
  `}function By(e){return e==null}function Yy(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"}var Mi=ar`
  opacity: 0;
`,Qy=ar`
  display: inline-block;
  white-space: pre;
`,Gp=e=>{const{cascade:t=!1,damping:n=.5,delay:r=0,duration:a=1e3,fraction:i=0,keyframes:o=Du,triggerOnce:l=!1,css:s,className:u,style:f,childClassName:m,childStyle:v,children:h,onVisibilityChange:w}=e,y=j.useMemo(()=>Hy({keyframes:o,duration:a}),[a,o]);return By(h)?null:Yy(h)?ce(Xy,{...e,animationStyles:y,children:String(h)}):Ty.isFragment(h)?ce(Kp,{...e,animationStyles:y}):ce(zy,{children:j.Children.map(h,(b,d)=>{if(!j.isValidElement(b))return null;const c=[s,y],p=r+(t?d*a*n:0);switch(b.type){case"ol":case"ul":return ce(ul,{children:({cx:g})=>ce(b.type,{...b.props,className:g(u,b.props.className),style:{...f,...b.props.style},children:ce(Gp,{...e,children:b.props.children})})});case"li":return ce(Af,{threshold:i,triggerOnce:l,onChange:w,children:({inView:g,ref:k})=>ce(ul,{children:({cx:_})=>ce(b.type,{...b.props,ref:k,className:_(m,b.props.className),css:g?c:Mi,style:{...v,...b.props.style,animationDelay:p+"ms"}})})});default:return ce(Af,{threshold:i,triggerOnce:l,onChange:w,children:({inView:g,ref:k})=>ce("div",{ref:k,className:u,css:g?c:Mi,style:{...f,animationDelay:p+"ms"},children:ce(ul,{children:({cx:_})=>ce(b.type,{...b.props,className:_(m,b.props.className),style:{...v,...b.props.style}})})})})}})})},Xy=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:a=0,duration:i=1e3,fraction:o=0,triggerOnce:l=!1,css:s,className:u,style:f,children:m,onVisibilityChange:v}=e,{ref:h,inView:w}=Yp({triggerOnce:l,threshold:o,onChange:v});return n?ce("div",{ref:h,className:u,css:[s,Qy],style:f,children:m.split("").map((y,b)=>ce("span",{css:w?t:Mi,style:{animationDelay:a+b*i*r+"ms"},children:y},b))}):ce(Kp,{...e,children:m})},Kp=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,css:a,className:i,style:o,children:l,onVisibilityChange:s}=e,{ref:u,inView:f}=Yp({triggerOnce:r,threshold:n,onChange:s});return ce("div",{ref:u,className:i,css:f?[a,t]:Mi,style:o,children:l})};C`
  from,
  20%,
  40%,
  60%,
...
`;function s2(e,t,n){switch(n){case"bottom-left":return t?Ky:Ay;case"bottom-right":return t?Zy:Ly;case"down":return e?t?qy:My:t?Jy:Ry;case"left":return e?t?t2:jy:t?e2:Du;case"right":return e?t?r2:Fy:t?n2:$y;case"top-left":return t?a2:Dy;case"top-right":return t?i2:Uy;case"up":return e?t?l2:Vy:t?o2:Wy;default:return t?Gy:Iy}}var Ir=e=>{const{big:t=!1,direction:n,reverse:r=!1,...a}=e,i=j.useMemo(()=>s2(t,r,n),[t,n,r]);return ce(Gp,{keyframes:i,...a})};C`
  from {
