 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ju=Symbol.for("react.element"),$u=Symbol.for("react.portal"),go=Symbol.for("react.fragment"),yo=Symbol.for("react.strict_mode"),wo=Symbol.for("react.profiler"),xo=Symbol.for("react.provider"),ko=Symbol.for("react.context"),Ny=Symbol.for("react.server_context"),So=Symbol.for("react.forward_ref"),Eo=Symbol.for("react.suspense"),Co=Symbol.for("react.suspense_list"),bo=Symbol.for("react.memo"),_o=Symbol.for("react.lazy"),Oy=Symbol.for("react.offscreen"),Xp;Xp=Symbol.for("react.module.reference");function Xe(e){if(typeof e=="object"&&e!==null){var t=e.$$typeof;switch(t){case ju:switch(e=e.type,e){case go:case wo:case yo:case Eo:case Co:return e;default:switch(e=e&&e.$$typeof,e){case Ny:case ko:case So:case _o:case bo:case xo:return e;default:return t}}case $u:return t}}}B.ContextConsumer=ko;B.ContextProvider=xo;B.Element=ju;B.ForwardRef=So;B.Fragment=go;B.Lazy=_o;B.Memo=bo;B.Portal=$u;B.Profiler=wo;B.StrictMode=yo;B.Suspense=Eo;B.SuspenseList=Co;B.isAsyncMode=function(){return!1};B.isConcurrentMode=function(){return!1};B.isContextConsumer=function(e){return Xe(e)===ko};B.isContextProvider=function(e){return Xe(e)===xo};B.isElement=function(e){return typeof e=="object"&&e!==null&&e.$$typeof===ju};B.isForwardRef=function(e){return Xe(e)===So};B.isFragment=function(e){return Xe(e)===go};B.isLazy=function(e){return Xe(e)===_o};B.isMemo=function(e){return Xe(e)===bo};B.isPortal=function(e){return Xe(e)===$u};B.isProfiler=function(e){return Xe(e)===wo};B.isStrictMode=function(e){return Xe(e)===yo};B.isSuspense=function(e){return Xe(e)===Eo};B.isSuspenseList=function(e){return Xe(e)===Co};B.isValidElementType=function(e){return typeof e=="string"||typeof e=="function"||e===go||e===wo||e===yo||e===Eo||e===Co||e===Oy||typeof e=="object"&&e!==null&&(e.$$typeof===_o||e.$$typeof===bo||e.$$typeof===xo||e.$$typeof===ko||e.$$typeof===So||e.$$typeof===Xp||e.getModuleId!==void 0)};B.typeOf=Xe;Qp.exports=B;var Ty=Qp.exports,zy=k.Fragment;function ce(e,t,n){return Ru.call(t,"css")?k.jsx(yy,hy(e,t),n):k.jsx(e,t,n)}C`
  from,
  20%,
  53%,
  to {
...
`;function By({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=Fu,iterationCount:a=1}){return ar`
  ...
  `}function Hy(e){return e==null}function Yy(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"}var Mi=ar`
  opacity: 0;
`,Qy=ar`
  display: inline-block;
  white-space: pre;
`,Gp=e=>{const{cascade:t=!1,damping:n=.5,delay:r=0,duration:a=1e3,fraction:i=0,keyframes:o=Fu,triggerOnce:l=!1,css:s,className:u,style:f,childClassName:d,childStyle:v,children:h,onVisibilityChange:w}=e,y=A.useMemo(()=>By({keyframes:o,duration:a}),[a,o]);return Hy(h)?null:Yy(h)?ce(Xy,{...e,animationStyles:y,children:String(h)}):Ty.isFragment(h)?ce(Kp,{...e,animationStyles:y}):ce(zy,{children:A.Children.map(h,(b,m)=>{if(!A.isValidElement(b))return null;const c=[s,y],p=r+(t?m*a*n:0);switch(b.type){case"ol":case"ul":return ce(sl,{children:({cx:g})=>ce(b.type,{...b.props,className:g(u,b.props.className),style:{...f,...b.props.style},children:ce(Gp,{...e,children:b.props.children})})});case"li":return ce(If,{threshold:i,triggerOnce:l,onChange:w,children:({inView:g,ref:x})=>ce(sl,{children:({cx:_})=>ce(b.type,{...b.props,ref:x,className:_(d,b.props.className),css:g?c:Mi,style:{...v,...b.props.style,animationDelay:p+"ms"}})})});default:return ce(If,{threshold:i,triggerOnce:l,onChange:w,children:({inView:g,ref:x})=>ce("div",{ref:x,className:u,css:g?c:Mi,style:{...f,animationDelay:p+"ms"},children:ce(sl,{children:({cx:_})=>ce(b.type,{...b.props,className:_(d,b.props.className),style:{...v,...b.props.style}})})})})}})})},Xy=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:a=0,duration:i=1e3,fraction:o=0,triggerOnce:l=!1,css:s,className:u,style:f,children:d,onVisibilityChange:v}=e,{ref:h,inView:w}=Yp({triggerOnce:l,threshold:o,onChange:v});return n?ce("div",{ref:h,className:u,css:[s,Qy],style:f,children:d.split("").map((y,b)=>ce("span",{css:w?t:Mi,style:{animationDelay:a+b*i*r+"ms"},children:y},b))}):ce(Kp,{...e,children:d})},Kp=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,css:a,className:i,style:o,children:l,onVisibilityChange:s}=e,{ref:u,inView:f}=Yp({triggerOnce:r,threshold:n,onChange:s});return ce("div",{ref:u,className:i,css:f?[a,t]:Mi,style:o,children:l})};C`
  from,
  20%,
  40%,
  60%,
...
`;function s2(e,t,n){switch(n){case"bottom-left":return t?Ky:Ay;case"bottom-right":return t?Zy:Ly;case"down":return e?t?qy:Ry:t?Jy:My;case"left":return e?t?t2:jy:t?e2:Fu;case"right":return e?t?r2:Fy:t?n2:$y;case"top-left":return t?a2:Dy;case"top-right":return t?i2:Uy;case"up":return e?t?l2:Vy:t?o2:Wy;default:return t?Gy:Iy}}var Ir=e=>{const{big:t=!1,direction:n,reverse:r=!1,...a}=e,i=A.useMemo(()=>s2(t,r,n),[t,n,r]);return ce(Gp,{keyframes:i,...a})};C`
  from {
